...
<section class="header">
      <div class="container">
            ...
            <div class="text-box">
                  ...
                  <p>HOT COFFEE / COLD COFFEE / PASTRIES / ADD-ONS</p>
    </div>
    </section>
                <!--menu-->
                <div class="menu reveal">
                    ...
                    <h1> HOT COFFEE </h1>
                        <div class="innerhot">
                        <img id="menuimg" width="300" height="300"src="haechan.jpg">
                        <img id="menulist" width="600" height="300"src="menu1.png">
                        </div>
                        <br>
                    <div class="hot">
                    <h1> ICED COFFEE </h1>
                        <div class="innerhot">
                        <img id="menulist" width="600" height="300"src="menu2.png">
                        <img id="menuimg" width="300" height="300"src="haechan.jpg">
                    </div>
                </div>
