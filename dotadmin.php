<?php
    ...
    $username = 'zayti';   //set ur username
...
<head>
    <meta charset="utf-8">
    <title> Zayti's Cafe Admin - Gallery </title>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" id="loginz" class="btn btn-primary">
                                    Login
                                </button>
...
<div class="h">
    <a href="dot1.php" id="butt">Back to Main Webpage</a>
</div>
</main>
<?php } else { ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" id="butt" class="btn btn-success">
                                    Upload
                                </button>
